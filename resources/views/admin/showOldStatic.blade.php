...
$result = DonationController::getOldDonationStatic($id);
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col mr-2">
                                ...
                                <div class=" h5 mb-1 font-weight-bold text-gray-800 pl-3"><?php echo ($id == 5 ) ? "100" : "73"?></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800  pl-3">{{$result['paid']}}</div>
                            </div>
                        </div>
                    </div>
                </div>
...
{{--        </div>--}}
        <div class="text-center m-2" dir="rtl">
                    <textarea name="" cols="50" rows="10" class="form-control" id="myInput" ><?php echo $result['data'] ?></textarea>
            <br>
